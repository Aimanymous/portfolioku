      ...
      items: [
        {
          ...
          github: 'https://github.com/Aimanymous',
          demo: 'https://'
        },
        {
          id: 2,
          name: 'Basuh',
          imageUrl: 'basuh',
          status: 'A Mobile website that disguise like a native app that has a responsive display to make it easier for people to booking carwash service from anywhere.',
          tech: 'Javascript, Firebase',
          github: 'https://github.com/Aimanymous',
          demo: 'https://servicebasuh.netlify.app/'
        },
       
        {
          id: 3,
          name: 'Cloud Skill Boost',
          imageUrl: 'go',
          status: 'I have gained a lot of knowledge in cloud computing, storage, networking, and other services by the extensively trained in Google Cloud.You can check my cloud skill boost profile.',
          tech: 'Google Cloud',
          github: 'null',
          demo: 'https://www.cloudskillsboost.google/public_profiles/38933a1e-7afb-44bf-989b-0669b6cacfe7'
        },
        {
          id: 4,
          name: 'Chat room',
          imageUrl: 'chat',
          status: 'This app is a real-time chat room using Firebase and React. Users sign in with Google, ensuring security. Firestore stores messages, React updates in real-time. Enjoy seamless and secure chatting through intuitive UI.',
          tech: 'React, Firebase',
          github: 'https://github.com/Aimanymous',
          demo: 'https://ffee-87ef9.web.app/'
        },
        {
          id: 5,
          name: 'Web Engineer project',
          imageUrl: 'stud',
          status: 'A website for manage final year project',
          tech: 'mySql, PHP',
          github: 'https://github.com/Aimanymous',
          demo: 'https://studyfyp.000webhostapp.com/'
        },
         {
          id: 6,
          name: 'Telegram Chatgpt bot',
          imageUrl: 'ai',
          status: 'Creating a 24/7 ChatGPT-powered chatbot for Telegram includes these steps: setting up a Telegram bot, integrating openAi key, hosting the script, refining responses, moderation, usage monitoring, and staying updated.',
          tech: 'Flask, Python',
          github: 'https://github.com/Aimanymous',
          demo: 'null'
        },
